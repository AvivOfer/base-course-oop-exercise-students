...
public class Shoval extends AerialVehicle implements Haron, AerialIntelligenceVehicle, AerialAttackVehicle, AerialBdaVehicle {
    private int nMissiles;
    private String missileType;
    private String sensorType;
    private String cameraType;

    public Shoval(String cameraType, int nMissiles, String missileType, String sensorType, String pilotName, Mission mission, int hoursOfFlightSinceLastRepair, boolean isReady) {
